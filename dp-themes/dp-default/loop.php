...
<?php if ( ! have_posts() ) : ?>
	<div id="post-0" class="post error404 not-found">
		<h1 class="entry-title"><?php _e( 'Not Found', 'directorypress' ); ?></h1>
		<div class="entry-content">
			<p><?php _e( 'Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.', 'directorypress' ); ?></p>
			<?php get_search_form(); ?>
		</div><!-- .entry-content -->
	</div><!-- #post-0 -->
<?php endif; ?>
...
<?php /* How to display posts in the Gallery category. */ ?>
	...
	<?php if ( in_category( _x('gallery', 'gallery category slug', 'directorypress') ) ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="entry-content">
                ...
                <?php else : ?>
                                ...
                                ?>
                                        ...
                                        <p><em><?php printf( __( 'This gallery contains <a %1$s>%2$s photos</a>.', 'directorypress' ),
                                                'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'directorypress' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
                                                $total_images
                                            ); ?></em></p>
                                <?php endif; ?>
                                        <?php the_excerpt(); ?>
			...
			<div class="entry-utility">
				<a href="<?php echo get_term_link( _x('gallery', 'gallery category slug', 'directorypress'), 'category' ); ?>" title="<?php esc_attr_e( 'View posts in the Gallery category', 'directorypress' ); ?>"><?php _e( 'More Galleries', 'directorypress' ); ?></a>
...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 'directorypress') ) ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
