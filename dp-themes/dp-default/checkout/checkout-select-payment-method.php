<form action="" method="post"  class="dp-sys-info">
    ...
    <span class="dp-submit-txt"><?php _e('Choose Payment Method', 'directorypress'); ?></span>
    <table>
        <tr>
            <th><label for="payment_method"><?php _e('PayPal', 'directorypress'); ?></label></th>
            <td>
        ...
        <tr>
            <th><label for="payment_method"><?php _e('Credit Card','directorypress'); ?></label></th>
            <td>
