...
<h2><?php _e('Directory Settings ', $this->text_domain); echo DR_VERSION;?></h2>
...
<h2 class="nav-tab-wrapper">
	...
	<a id="dr-settings_payments_type" class="nav-tab <?php if ( $tab == 'payments-type' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_attr('admin.php?page=directory_settings&tab=payment-types');?>"><?php _e( 'Payments Type', $this->text_domain ); ?></a>
