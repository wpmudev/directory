...
<div class="wrap">
    ...
    <?php $this->render_admin( 'navigation', array( 'page' => 'settings', 'tab' => 'payments', 'sub' => 'type' ) ); ?>
        ...
        <div class="ui-tabs ui-widget ui-widget-content ui-corner-all" id="tabs">
            <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
                <?php if ( 1 == $gateways['paypal'] ): ?>
                    <li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active"><a href="#tabs-1"><?php _e( 'PayPal', $this->text_domain ) ?></a></li>
                <?php endif;?>
                <?php if ( 1 == $gateways['authorize_net'] ): ?>
                <li class="ui-state-default ui-corner-top"><a href="#tabs-2"><?php _e( 'Authorize.net', $this->text_domain ) ?></a></li>
                <?php endif;?>
            </ul>
            ...
            <form action="" method="post" name="paypal_" class="dp-payments">
                ...
                <div class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="tabs-1">
                    <h3><?php _e( 'PayPal Settings', $this->text_domain ) ?></h3>
                    <table class="form-table">
                        <tr>
                            <th>
                ...
                <div class="ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide" id="tabs-2">
                    <h3><?php _e( 'Authorize.net Settings', $this->text_domain ) ?></h3>
                    <table class="form-table">
                        <tr>
