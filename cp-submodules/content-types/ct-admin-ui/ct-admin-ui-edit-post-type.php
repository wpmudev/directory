...
/**
 * ct_admin_ui_edit_post_type()
 *
 * Outputs "Edit Post Type" admin page.
 *
 * @param array $args The post type that is about to be updated
 * with all of its settings.
 */
function ct_admin_ui_edit_post_type( $args ) { ?>
    ...
    <form action="" method="post" class="ct-post-type">
        ...
        <div class="ct-wrap-left">
            <div class="ct-table-wrap">
                ...
                <table class="form-table">
                    <tr>
                        <th>
                            <label for="post_type"><?php _e('Post Type', 'content_types') ?> (<span class="ct-required"> required </span>)</label>
                        </th>
                        <td>
                            <input type="text" name="post_type" value="<?php echo ( $_GET['ct_edit_post_type'] ) ?>" disabled="disabled">
        ...
        <input type="submit" class="button-primary" name="ct_submit_update_post_type" value="Update Post Type">
        <br /><br /><br /><br />
    </form> <?php
}
?>
