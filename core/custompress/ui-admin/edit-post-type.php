			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						...
						<br /><br />
						<label>
							<input type="checkbox" name="rewrite_with_front" value="1" <?php checked( ! isset($post_type['rewrite_with_front']) || ! empty( $post_type['rewrite_with_front'] )); ?> />
						...
						<br /><br />
						<label>
							<input type="checkbox" name="rewrite_feeds" value="1" <?php checked( ! empty( $post_type['rewrite_feeds'] ) ); ?> />
						...
						<br />
						<label>
							<input type="checkbox" name="rewrite_pages" value="1" <?php checked( ! isset($post_type['rewrite_pages']) || ! empty( $post_type['rewrite_pages'] ) ); ?> />
