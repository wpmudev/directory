...
<div class="wrap ct-wrap ct-content-types">
	...
	<h2>
		...
		<a class="nav-tab <?php if ( isset( $_GET['ct_content_type'] ) && $_GET['ct_content_type'] == 'shortcodes' ) { echo( 'nav-tab-active' ); } ?>" href="<?php echo esc_attr('admin.php?page=ct_content_types&ct_content_type=shortcodes'); ?>"><?php _e('Shortcodes', $this->text_domain); ?></a>
	</h2>
